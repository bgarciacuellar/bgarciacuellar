...
const modalViews = document.querySelectorAll('.services__modal'),
      ...
      modalCloses = document.querySelector('.services__modal-close')
...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'uil-toggle-off' : 'uil-toggle-on'

// We validate if the user previously chose a topic
if (selectedTheme) {
  // If the validation is fulfilled, we ask what the issue was to know if we activated or deactivated the dark
  document.body.classList[selectedTheme === 'dark' ? 'add' : 'remove'](darkTheme)
  themeButton.classList[selectedIcon === 'uil-toggle-off' ? 'add' : 'remove'](iconTheme)
}
